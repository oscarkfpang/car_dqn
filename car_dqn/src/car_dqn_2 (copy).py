...
def train():
    ...
    for e in range(EPISODES):
        ...
        if e % 10 == 0 and e > 10 and not manualDrive.value:
            agent.save_model("/home/oscar/catkin_ws/src/car_dqn/src/cardqn.h5")
...
def ReceiveJoystickMessage(data):
    ...
    if data.buttons[ButtonReverse]==1:
        rospy.loginfo("============ Reverse Gear Toggled ================")
        manual_gear.value = -1
    else:
        manual_gear.value = 1
...
if __name__ == "__main__":
    ...
    agent.load_model("/home/oscar/catkin_ws/src/car_dqn/src/cardqn.h5")
